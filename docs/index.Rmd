---
title: 'TAXA DE CÂMBIO </br> (TEMA 03)'
...
- São alguns exemplos de taxa de câmbio nominal:
  ...
  - $e_{real/dólar} =$ `r scales::number(x = cambio_nominal_dolar_h$value, decimal.mark = ',', accuracy = 0.0001, suffix = ' R$/USD')`

  - $e_{real/euro} =$ `r scales::number(x = cambio_nominal_euro_h$value, decimal.mark = ',', accuracy = 0.0001, suffix = ' R$/EUR')`
  
  - $e_{real/iene} =$ `r scales::number(x = cambio_nominal_iene_h$value, decimal.mark = ',', accuracy = 0.0001, suffix = ' R$/JPY')`
...
análise pode ser contraintuitiva:
  ...
  **desvalorização cambial** (ou **valorização da moeda local - real**);
...
mesmo bem ou serviço entre países diferentes;
...
- São alguns exemplos de taxa de câmbio real:
  ...
  - $E_{real/dólar} =$ `r scales::number(x = cambio_nominal_dolar_h$value, decimal.mark = ',', accuracy = 0.0001)`

  - $E_{real/euro} =$ `r scales::number(x = cambio_nominal_euro_h$value, decimal.mark = ',', accuracy = 0.0001)`
  
  - $E_{real/iene} =$ `r scales::number(x = cambio_nominal_iene_h$value, decimal.mark = ',', accuracy = 0.0001)`
